...
public class Grid extends JComponent implements KeyListener, MouseListener
{
  ...
  {//constructor of this Grid object
  ...
  //its gonna return the number of rows right away cuz it has initialized at the very begining
  ...
  //its gonna return nothing just set the file name of specified location as you specified 
  public void setImage(Location loc, String imageFileName)
  {//takes Object in as a parameter and fileName
    if (!isValid(loc))
    {
    ...
    //invoking a setImageFileName from Cell object because cells[][] array is in a cell class
  ...
  public String getImage(Location loc)
  {
    ...
    //invoking getImageFileName method of reference variable of type Cell in a 2d array cells 
  }
